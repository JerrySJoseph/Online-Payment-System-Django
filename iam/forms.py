...
class RegisterForm(forms.Form):
    ...
    password = forms.CharField(widget=forms.PasswordInput(), required=True,validators=[password_validator])
    ...
    def clean(self):
        ...
        if cleaned_data.get('tnc_check')==False:
            self.add_error('tnc_check','You need to accept Terms and Conditions first.')
